...
def run_seed():
  try:
    all_seed_info=[SeedInfo(Users,'users.data.json'),SeedInfo(Products,'products.data.json'),SeedInfo(Orders,'orders.data.json'),SeedInfo(ConsumedLogs,'consumed_logs.data.json'),]
